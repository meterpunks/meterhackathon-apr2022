...
export default class Dapp extends React.Component<Props, State> {
  ...
  componentDidMount = async () => {
    ...
    if (browserProvider?.isMetaMask !== true) {
      this.setError( 
        <>
          We were not able to detect <strong>MetaMask</strong>. We value <strong>privacy and security</strong> a lot so we limit the wallet options on the DAPP.
        </>,
      );
    }
      ...
      <>
              ...
              <>
                ...
                {this.state.totalSupply < this.state.maxSupply ?
                  ...
                  <div className="collection-sold-out">
                    ...
                    You can buy from secondary market tofuNFT.com.
                  </div>
                }
              </>
              :
        ...
        {!this.isWalletConnected() || !this.isSoldOut() ?
          <div className="no-wallet">
            ...
            <a href={this.generateContractUrl()} target="_blank">CONTRACT</a>
            </div>
